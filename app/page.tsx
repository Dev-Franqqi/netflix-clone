      ...
      <main className="h-screen w-screen">
        ...
        <section className="text-white   text-center md:h-screen w-screen border-b-8 border-b-neutral-800 h-5/6 bg-slate-400">
          ...
          <section className="px-4 w-screen h-full mt-10 py-6 mx-auto absolute top-1">
            <div className="mb-16 w-full mx-auto px-5 flex justify-between md:px-40">
              ...
              <Link href="/signin">
                <Button className="bg-red-600 rounded-md h-fit py-1 px-2 md:py-2 md:px-5 w-fit ">
                  Sign in
                </Button>
              </Link>
            </div>

            <h1 className="font-bold md:font-extrabold text-4xl md:mt-40 md:text-5xl">
              Unlimited movies, Tv shows, and more
            </h1>

            <p className="mt-2 mb-2 text-lg md:font-semibold md:text-2xl md:mt-4">
              Watch anywhere. Cancel anytime.
            </p>

            <p className="px-12 mt-1 md:font-semibold md:text-xl">
            ...
            <div className="flex items-center flex-col mt-7 md:flex-row max-w-lg md:mx-auto justify-around  space-x-2">
              <Input
                type="email"
                className="py-6 w-full bg-transparent text-base bg-opacity-50 border-neutral-600 placeholder:text-gray-400"
                placeholder="Email address"
              />
              <Button
                className=" mt-3  py-6 text-xl  md:mt-0  w-3/5 bg-red-600 hover:bg-red-600"
                type="submit"
              >
                Get Started{" "}
                <svg
        ...
        <section className="w-full bg-black h-fit border-b-8 border-b-neutral-800 px-8 py-6 text-white text-center md:flex ">
          <div className="md:w-3/5 md:pt-20 md:px-32 md:text-left">
            <h2 className="font-bold text-3xl mt-10 md:text-5xl md:font-extrabold">
              Enjoy on your TV
            </h2>
            <p className="text-lg mt-3 md:text-2xl">
              Watch on Smart Tvs, Playstatio, Xbox, Chromecast, Apple TV,
        ...
        <section className="text-white w-full text-center bg-black border-b-8 border-b-neutral-800 py-6 px-8 md:py-20 ">
          <div className="md:w-4/5 md:flex  md:flex-row-reverse md:mx-auto ">
            <div className=" md:text-left">
              <h3 className="text-3xl  mt-10 font-extrabold mb-2 md:text-extrabold md:text-5xl md:leading-normal ">
        ...
        <section className="text-white text-center md:text-left bg-black border-b-8 border-b-neutral-800 w-full md:py-16 bg py-8 px-8">
          <div className="md:ml-48">
            <h3 className="text-3xl md:w-1/5 md:text-5xl font-extrabold mt-8 mb-2 md:leading-normal">
              Watch everywhere
            </h3>

            <p className="text-lg md:text-2xl md:w-2/6 md:font-normal">
              Stream unlimited movies and TV shows on your phone tabet, laptop,
              and TV.
            </p>
          </div>
        </section>
        ...
        <section className="text-white text-center py-8 px-12 border-b-8 bg-black border-b-neutral-800 md:flex md:flex-row-reverse md:text-left">
          <div>
            ...
            <p className=" md:max-w-lg text-lg md:text-2xl md:font-normal">
              ...
              made just for them &mdash;{" "}
              <span className="md:block">free with your membership</span>
            </p>
          </div>
        ...
        <section className=" text-white text-center py-8  border-b-8 bg-black  border-b-neutral-800">
          <h3 className="text-3xl md:font-extrabold font-bold mb-5 mt-8">
            Frequently Asked Questions
          </h3>
          <Dropdown />

          <h3 className="text-center text-lg md:text-2xl px-4">
            Ready to watch? Enter your email to create or restart your
            membership.
          </h3>
          ...
          <div className="flex items-center flex-col mt-7 md:flex-row max-w-lg md:mx-auto justify-around  space-x-2">
            <Input
              type="email"
              className="py-6 border border-green-500 w-5/6 bg-transparent text-base bg-opacity-50 placeholder:text-gray-400"
              placeholder="Email address"
            />
            <Button
              className=" mt-3  py-6 text-xl  md:mt-0  w-3/5 bg-red-600 hover:bg-red-600"
